...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/11/2024 às 03:02
...
--
CREATE DATABASE IF NOT EXISTS `bibliotecabd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bibliotecabd`;
...
INSERT INTO `livros` (`id`, `titulo`, `autor`, `genero`, `status_disponibilidade`) VALUES
(11, 'a', 'a', 'a', 'Indisponivel');
...
INSERT INTO `alunos` (`id`, `nome`, `rm`) VALUES
(1, 'Daniel Moura', '22111'),
(5, 'Daniel teste', '12345'),
(6, 'conexao', '2412'),
(9, 'SS', 'S');
...
('root', '[{\"db\":\"bibliotecabd\",\"table\":\"livros\"},{\"db\":\"escola\",\"table\":\"alunos\"}]');
...
('root', '2024-11-26 02:02:16', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
